...
This file contains all definitions needed like CC1101 register adresses or pins configuration

Modify this file is not recommended 

*/

//*************************************** Pins **************************************************//
#define SS_PIN_DEFAULT    8
#define GDO0_DEFAULT	2
#define GDO2_DEFAULT	9


// Reading state of SO is important to be sure that internal oscillator is working. But the reading is pin dependant and digitalRead() on MISO in Energia
// meets some troubles

#ifdef ENERGIA
#if defined(__MSP430G2553) || defined(__MSP430G2452) // on Energia + MSP430G2553 or MSP430G2452
#define READMISOPIN P1IN&BIT6 // MISO is on P1.6
#endif
#else
#define READMISOPIN digitalRead(MISO) // on Arduino
#endif
...
#define CC1101_STATE_TXFIFOUNDERFLOW  0x16
